...
def main():
    train_dataset, test_dataset = parse_dataset_from_xls("M3C.xls", SheetType.YEARLY, row=227, output_len=6, preprocessing=PreprocessingTimeSeries.NORMALIZE)
    ...
    model: TransformerLikeModel = TransformerLikeModel(embed_size=32, encoder_size=1, decoder_size=2, output_len=6)
