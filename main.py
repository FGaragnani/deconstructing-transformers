...
def main():
    train_dataset, test_dataset = parse_dataset_from_xls("M3C.xls", SheetType.YEARLY, row=1, output_len=6, preprocessing=PreprocessingTimeSeries.NONE)
    ...
    model: TransformerLikeModel = TransformerLikeModel(embed_size=768, encoder_size=4, decoder_size=6, output_len=6)
